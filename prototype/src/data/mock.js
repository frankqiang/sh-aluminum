...
export const precisionPlans = [
  // ===== 已完成 =====
  {
    ...
    coronaPasses: 2,
    plan: [
      { seq: 1, type: 'order', orderNo: 'SZ25121602434', customer: '弘力科技', orderWidth: 654, lengthMin: 6500, lengthMax: 7000, grade: '二级品' },
      { seq: 2, type: 'order', orderNo: 'SZ25121602435', customer: '源元科技', orderWidth: 860, lengthMin: 14000, lengthMax: 16000, grade: '一级品' },
    ],
  ...
  },
  {
    ...
    coronaPasses: 1,
    plan: [
      { seq: 1, type: 'order', orderNo: 'SZ25121602440', customer: '河北兴恒', orderWidth: 875, lengthMin: 14000, lengthMax: 16000, grade: '一级品' },
    ],
    edgeTrimLeft: 8, edgeTrimRight: 8,
    seqReason: '',
    note: '',
  ...
  },
  {
    ...
    coronaPasses: 2,
    plan: [
      { seq: 1, type: 'order', orderNo: 'SZ25121602441', customer: '中航锂电', orderWidth: 640, lengthMin: 12000, lengthMax: 14000, grade: '一级品' },
      { seq: 2, type: 'order', orderNo: 'SZ25121602442', customer: '弘力科技', orderWidth: 640, lengthMin: 12000, lengthMax: 14000, grade: '一级品' },
    ],
    edgeTrimLeft: 8, edgeTrimRight: 8,
  ...
  },
  {
    ...
    coronaPasses: 1,
    plan: [
      { seq: 1, type: 'order', orderNo: 'SZ25121602450', customer: '源元科技', orderWidth: 870, lengthMin: 14000, lengthMax: 16000, grade: '一级品' },
    ],
    edgeTrimLeft: 8, edgeTrimRight: 8,
    seqReason: '',
    note: '',
  ...
  },
  {
    ...
    coronaPasses: 2,
    plan: [
      { seq: 1, type: 'order', orderNo: 'SZ25121602455', customer: '河北兴恒', orderWidth: 752, lengthMin: 13000, lengthMax: 16000, grade: '一级品' },
      { seq: 2, type: 'order', orderNo: 'SZ25121602456', customer: '河北兴恒', orderWidth: 752, lengthMin: 13000, lengthMax: 15000, grade: '一级品' },
    ],
    edgeTrimLeft: 8, edgeTrimRight: 8,
  ...
  // ===== 进行中 =====
  {
    ...
    coronaPasses: 1,
    plan: [
      { seq: 1, type: 'order', orderNo: 'SZ25121602460', customer: '弘力科技', orderWidth: 756, lengthMin: 13000, lengthMax: 16000, grade: '一级品' },
      { seq: 2, type: 'order', orderNo: 'SZ25121602461', customer: '源元科技', orderWidth: 648, lengthMin: 12000, lengthMax: 16000, grade: '一级品' },
    ],
    edgeTrimLeft: 8, edgeTrimRight: 8,
  ...
  },
  {
    ...
    coronaPasses: 2,
    plan: [
      { seq: 1, type: 'order', orderNo: 'SZ25121602462', customer: '中航锂电', orderWidth: 872, lengthMin: 10000, lengthMax: 12000, grade: '一级品' },
    ],
    edgeTrimLeft: 8, edgeTrimRight: 8,
    seqReason: '',
  ...
  // ===== 待评审 =====
  {
    ...
    coronaPasses: 2,
    plan: [
      { seq: 1, type: 'order', orderNo: 'SZ25121602470', customer: '弘力科技', orderWidth: 520, lengthMin: 12000, lengthMax: 15000, grade: '一级品' },
      { seq: 2, type: 'order', orderNo: 'SZ25121602471', customer: '河北兴恒', orderWidth: 864, lengthMin: 10000, lengthMax: 11000, grade: '一级品' },
    ],
    edgeTrimLeft: 8, edgeTrimRight: 8,
    seqReason: '',
    note: '',
  ...
  },
  {
    ...
    coronaPasses: 1,
    plan: [
      { seq: 1, type: 'order', orderNo: 'SZ25121602475', customer: '源元科技', orderWidth: 753, lengthMin: 13000, lengthMax: 16000, grade: '一级品' },
    ],
    edgeTrimLeft: 8, edgeTrimRight: 8,
    seqReason: '',
    note: '18042米后针孔切654',
  ...
  // ===== 计划中 =====
  {
    ...
    coronaPasses: 2,
    plan: [
      { seq: 1, type: 'order', orderNo: 'SZ25121602480', customer: '弘力科技', orderWidth: 337, lengthMin: 9000, lengthMax: 8200, grade: '二级品' },
      { seq: 2, type: 'order', orderNo: 'SZ25121602481', customer: '河北兴恒', orderWidth: 300, lengthMin: 2700, lengthMax: 2800, grade: '二级品' },
      { seq: 3, type: 'order', orderNo: 'SZ25121602482', customer: '源元科技', orderWidth: 337, lengthMin: 9000, lengthMax: 8200, grade: '一级品' },
    ],
    edgeTrimLeft: 8, edgeTrimRight: 8,
